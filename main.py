...
os.system("gnome-extensions install blur-my-shell@aunetx")
os.system("gnome-extensions install caffeine@patapon.info")
os.system("gnome-extensions install clipboard-indicator@tudmotu.com")
os.system("gnome-extensions install dash-to-dock@micxgx.gmail.com")
os.system("gnome-extensions install drive-menu@gnome-shell-extensions.gcampax.github.com")
os.system("gnome-extensions install fullscreen-notifications@sorrow.about.alice.pm.me")
os.system("gnome-extensions install noannoyance@daase.net")
os.system("gnome-extensions install notification-banner-reloaded@marcinjakubowski.github.com")
os.system("gnome-extensions install reboottouefi@ubaygd.com")
